...
public class TC18_LoginWithWrongCredentialsTest {
    ...
    void createContextAndPages() {
        ...
        test = ReporterFactory.createTest("TC18_LoginTest", "Test that checks a faulty login.");
    }
    ...
    @Test
    public void TC18_AT_LoginWithWrongCredentialsTest() {
        loginPage.navigate();
